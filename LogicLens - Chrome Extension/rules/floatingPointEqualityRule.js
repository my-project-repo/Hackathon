function detectFloatingPointEquality(ast) {
  ...
  traverseAst(ast, (node) => {
    ...
    detections.push({
      ...
      topic:
        "Numerical Computing and Precision Errors",

      learningHint:
        "Decimal values are often stored approximately in binary, so direct floating-point equality checks may fail unexpectedly.",
